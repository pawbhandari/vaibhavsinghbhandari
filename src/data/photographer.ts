...
export const photographerInfo: PhotographerInfo = {
  ...
  tagline: "Versatile Video Editor & graphic designer for All Company Niches",
  heroIntroduction: "From High-Energy Edits to Cinematic Calm – Let's Create Yours.",
  biography: `Vaibhav Singh Bhandari is a dynamic video editor and creator delivering high-impact content for companies across all niches. With expertise in motion graphics, podcast editing, educational videos, real estate and 3D reels, I transforms ideas into polished visuals using After Effects, Premiere Pro, Illustrator, and Photoshop.
...
From podcast polishing to 3D reels and educational content, his process guarantees videos that engage audiences and drive results for brands worldwide.`,
  awards: [
    "2nd Place - Best Sound Design, Internal Video Editing Cohort Competition",
